...
<main>
	...
	<div class="section">
		...
		<div class="text">
			...
			<p>I occasionally write in <a href="https://dev.to/marcialcambronero" target="_blank" rel="noopener">DEV.TO</a></p>
		</div>
	</div>
	<div class="section">
		<div class="heading">
		...
		<div class="text">
			<a class="contact-link" href="https://www.linkedin.com/in/marcialcambronero/" target="_blank" rel="noopener">
			...
			<a class="contact-link" href="https://github.com/marcialca" target="_blank" rel="noopener">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 24 28">
			...
			<a class="contact-link" href="https://twitter.com/MarcialC" target="_blank" rel="noopener">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 24 28">
